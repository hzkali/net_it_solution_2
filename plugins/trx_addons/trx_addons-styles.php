...
if ( ! function_exists( 'netmix_trx_addons_add_theme_vars' ) ) {
	add_filter( 'netmix_filter_add_theme_vars', 'netmix_trx_addons_add_theme_vars', 10, 2 );
	function netmix_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'netmix_trx_addons_get_css' ) ) {
	add_filter( 'netmix_filter_get_css', 'netmix_trx_addons_get_css', 10, 2 );
	function netmix_trx_addons_get_css( $css, $args ) {
...
.sc_icons_modern .sc_icons_item_description b {
...
.rev_slider ul[class*="trx_addons_list"][class*="_circled"] > li:before{
...
.swiper-pagination-custom .swiper-pagination-button {
	border-color: {$colors['text_dark_01']};
...
.sc_icons.sc_icons_default .sc_icons_item_description a {
	color: {$colors['text']};
}
.sc_icons.sc_icons_default .sc_icons_item_description a:hover{
	color: {$colors['text_link']};
}
...
.sc_price .sc_price_item.dark_item .sc_price_item_subtitle {
	color: {$colors['extra_dark']};
}
...
.sc_price .sc_price_item.dark_item .sc_price_item_title,
.sc_price .sc_price_item.dark_item .sc_price_item_title a,
.sc_price .sc_price_item.dark_item .sc_button_simple:not(.sc_button_bg_image){
	color: {$colors['extra_dark']};
}
...
.sc_price .sc_price_item.dark_item .sc_price_item_price{
	color: {$colors['extra_dark']};
}
.sc_price .sc_price_item.sc_price_item_feature .sc_price_item_price{
	color: {$colors['alter_hover2']};
}
.sc_price_item .sc_price_item_description,
.sc_price_item .sc_price_item_details ul[class*="trx_addons_list"][class*="_circled"]>li {
	color: {$colors['inverse_hover']};
}
.sc_price_item .sc_price_item_details ul[class*="trx_addons_list"][class*="_circled"]>li:before{
	color: {$colors['inverse_hover']};
	border-color: {$colors['inverse_hover']};
}
.sc_price .sc_price_item.dark_item .sc_price_item_description,
.sc_price .sc_price_item.dark_item .sc_price_item_details,
.sc_price .sc_price_item.dark_item .sc_price_item_details ul li,
.sc_price .sc_price_item.dark_item .sc_price_item_details ul li:before{
	color: {$colors['extra_dark']};
	border-color: {$colors['extra_dark']};
}
.sc_price .sc_price_item.sc_price_item_feature .sc_price_item_details ul li:before{
	color: {$colors['text_link2']};
	border-color: {$colors['text_link2']};
}
.sc_price .sc_price_item.sc_price_item_default:not(.dark_item) .sc_button{
	background-color: {$colors['text_hover3']};
	color: {$colors['text_link3']};
}
.sc_price .sc_price_item.sc_price_item_default:not(.dark_item) .sc_button:hover{
	color: {$colors['text_hover3']};
...
.scheme_dark .author_bio .socials_wrap .social_item .social_icon {
	background-color: {$colors['alter_bd_hover']};
}
...
.sc_layouts_row_type_narrow .sc_layouts_login .sc_layouts_iconed_text_line1{
	color:{$colors['alter_hover2']};
}
.sc_layouts_row_type_narrow .sc_layouts_login .sc_layouts_iconed_text_line3{
	color:{$colors['text_dark']};
}
.sc_layouts_row_type_narrow .sc_layouts_login:hover .sc_layouts_iconed_text_line1,
.sc_layouts_row_type_narrow .sc_layouts_login:hover .sc_layouts_iconed_text_line3{
	color:{$colors['alter_link2']};
}
