...
if ( ! function_exists( 'netmix_gutenberg_add_theme_vars' ) ) {
	add_filter( 'netmix_filter_add_theme_vars', 'netmix_gutenberg_add_theme_vars', 10, 2 );
	function netmix_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'netmix_gutenberg_get_css' ) ) {
	add_filter( 'netmix_filter_get_css', 'netmix_gutenberg_get_css', 10, 2 );
	function netmix_gutenberg_get_css( $css, $args ) {
